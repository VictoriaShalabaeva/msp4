...
class Product(models.Model):
    category = models.ForeignKey('Category', null=True, blank=True, on_delete=models.SET_NULL)
    number_id = models.DecimalField(max_digits=6, decimal_places=2, null=True, blank=True)
    name = models.CharField(max_length=254)
    ...
    api_featured_image = models.URLField(max_length=1024, null=True, blank=True)
