...
## [W3C Markup Validator](https://validator.w3.org/) detected the following errors:
  ...
  **Add a Product page**
  ...
  Strangely, if the html code of the page is checked in Chrome DevTools, there is no such id="image_id". It appears if one accesses the code from "View page source* button in browser.
